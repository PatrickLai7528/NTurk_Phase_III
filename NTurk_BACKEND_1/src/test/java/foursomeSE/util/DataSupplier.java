...
public class DataSupplier {
    ...
    public static List<Requester> mockRequesters() {
    ...
    public static List<Task> mockTasks() {
        ...
        t1.setTaskId(0);
        t1.setTaskName("巡址寻址");
        t1.setTaskDescription("请在图中框出你认为有价值的物体，并作出描述");
        t1.setRequesterId(0);
...
//        t1.setEndTime(LocalDateTime.now().minusDays(10));
        ...
        t2.setTaskId(1);
        t2.setTaskName("相面");
        t2.setTaskDescription("请框出你认识的名人脸");
        t2.setRequesterId(0);
        ...
        t3.setTaskId(2);
        t3.setTaskName("伤痕累累");
        t3.setTaskDescription("请根据图中隐秘的情感，回答下列隐秘的问题");
        t3.setRequesterId(1);
        ...
        t3.setQuestions(new String[]{"红袖添香夜读书", "那时年少春衫冷", "梦里不知身是客", "笑渐不闻声渐悄"});

        t3.setRewardStrategy(RewardStrategy.TOTAL);
        t3.setTotalReward(300);

        t3.setImgNames(new String[] {
    ...
    public static List<Contract> mockContract() {
