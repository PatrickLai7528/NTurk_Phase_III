<template >
    <div class = "signUp" >
        <el-form :model = "ruleForm" :rules = "rules" ref = "ruleForm" label-width = "100px" >
            ...
            <el-form-item label = "工人标签" prop = "userTags" v-if = "ruleForm.userType==='WORKER'"
                          style = "text-align: left" >
                <el-button size = "mini" @click = "dialogFormVisible = true" style = "font-size: 16px; align: left"
                           round >...</el-button >
            ...
            <el-form-item label = "用户头像" prop = "userIcon" >
                <el-upload ref = "upload" :multiple = "false" :action = 'userIconUploadURL'
                    ...
                    <div class = "upload-button-div" >
                        <el-button type = "text" class = "upload-button" >选取文件</el-button >
                    </div >
                </el-upload >
            </el-form-item >
            <el-form-item >
                <el-button class = "signUpButton" type = "info" @click = "submitForm('ruleForm')" >注册</el-button >
            </el-form-item >
        </el-form >
    </div >
</template >
